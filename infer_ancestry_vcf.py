...
def main(args):
    ...
    cmd_infer_ancestry = 'python {} --vcf_path {}'.format(args.ancestry_script, vcf_path)
    ...
    cmd_infer_ancestry = 'python {} --vcf_path {} --snpwt_path {} --snpwt_bed_path {}'.format(args.ancestry_script,
                                      vcf_path, args.snpwt_as_path, args.snpwt_as_bed_path)
    # run cmd_infer_ancestry
    if not os.path.isfile(predpc_path):
